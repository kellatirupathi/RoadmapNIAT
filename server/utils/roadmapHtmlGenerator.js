// // server/utils/roadmapHtmlGenerator.js
...
<body>
  ...
  ${roles.map((role, roleIndex) => `
    <div class="role-section" id="role-${roleIndex}" style="display: ${roleIndex === 0 ? 'block' : 'none'};">
      ${(role.title.toLowerCase().includes('foundation') || (roles.length > 1 && roleIndex === 0)) ? `
      ...
      <div class="foundation-info">
        <div class="info-box">
          ...
          <div class="info-text">
            ...
            <span style="color: #F7DF1E; font-weight: 600; background-color: #323330; padding: 0 2px; border-radius: 2px;">JS</span>, 
