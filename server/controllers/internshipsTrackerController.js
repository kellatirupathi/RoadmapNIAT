...
// // Removed the import for CriticalPoints
// // --- END OF MODIFICATION ---
    ...
    try {
        ...
        if (sheetName === 'companywise-students-progress') {
            ...
            for (const row of dataRows) {
                ...
                // Parse stipend with comma handling
                let stipendPerMonth = 0;
                if (lcRow['stipend per month']) {
                    // Remove commas and convert to number
                    stipendPerMonth = Number(lcRow['stipend per month'].toString().replace(/,/g, ''));
                }
