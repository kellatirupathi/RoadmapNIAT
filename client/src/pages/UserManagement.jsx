...
// import { Form, Button, Modal, Alert, Table, Badge, Dropdown, InputGroup, Card, Row, Col, Spinner } from 'react-bootstrap'; // Added Card, Row, Col, InputGroup, Spinner
// import userService from '../services/userService';
// import * as techStackService from '../services/techStackService'; 
// import { getRoleDisplayName, getRoleBadgeColor } from '../services/rolesService'; // Updated import
...
//     username: '', email: '', password: '', firstName: '', lastName: '', role: 'crm', assignedTechStacks: []
//   });
...
//         const techStacksResponse = await techStackService.getAllTechStacks();
...
//     try {
//       setLoading(true); // Indicate table loading
...
//     setNewUser({ username: '', email: '', password: '', firstName: '', lastName: '', role: 'crm', assignedTechStacks: [] });
...
//     } else {
//         setSelectedUser(prev => ({ ...prev, [name]: type === 'switch' ? checked : value }));
//     }
//   };
...
//     setActionLoading(true);
//     try {
//       const { _id, username, email, firstName, lastName, role, isActive, assignedTechStacks } = selectedUser;
...
//     setError(null); setSuccess(null);
//     setActionLoading(true); // Use actionLoading for this specific action too
//     try {
...
//   const TechStackDropdownDisplay = ({ techStacks }) => { // Renamed for clarity
...
//           <p className="text-muted mb-0">Administer user accounts and roles.</p>
//         </Col>
//         <Col xs="auto">
//           <Button 
//             variant="primary" 
...
//       {error && !showAddUserModal && !showEditUserModal && !showResetPasswordModal && !showDeleteUserModal && (
...
//           <Row className="g-3">
//             <Col md={6}>
//                 <Form.Label htmlFor="userSearchInput" className="small fw-medium">Search Users</Form.Label>
//                 <InputGroup>
...
//             <Table hover className="m-0 user-table">
...
//                   <tr>
//                     <td colSpan="8" className="text-center py-5">
//                       <div className="mb-3"><i className="fas fa-users-slash fa-3x text-muted"></i></div>
//                       <h5 className="mb-1">No Users Found</h5>
//                       <p className="text-muted small">
//                         {searchTerm || roleFilter !== 'all' ? "Try adjusting your search or filter criteria." : "There are no users to display."}
//                       </p>
//                     </td>
//                   </tr>
//                 )}
...
//                     <td>{u.firstName && u.lastName ? `${u.firstName} ${u.lastName}` : <span className="text-muted fst-italic">N/A</span>}</td>
//                     <td><a href={`mailto:${u.email}`} className="text-decoration-none">{u.email}</a></td>
//                     <td>
//                       <Badge bg={getRoleBadgeColor(u.role)} pill className="px-2 py-1 user-role-badge">
//                         {getRoleDisplayName(u.role)}
//                       </Badge>
//                     </td>
//                     <td>
//                       {u.role === 'instructor' ? (
//                         <TechStackDropdownDisplay techStacks={u.assignedTechStacks} />
//                       ) : (
//                         <span className="text-muted small">N/A</span>
//                       )}
//                     </td>
//                     <td>
//                       <Badge pill bg={u.isActive ? 'success-subtle' : 'danger-subtle'} text={u.isActive ? 'success' : 'danger'} className="border user-status-badge">
//                         <i className={`fas fa-circle me-1 fa-xs ${u.isActive ? 'text-success' : 'text-danger'}`}></i>
//                         {u.isActive ? 'Active' : 'Inactive'}
//                       </Badge>
//                     </td>
//                     <td className="small text-muted">{u.lastLogin ? new Date(u.lastLogin).toLocaleString() : 'Never'}</td>
//                     <td className="text-center">
//                       <Dropdown>
//                         <Dropdown.Toggle variant="link" id={`dropdown-actions-${u._id}`} className="p-1 text-muted no-caret">
//                             <i className="fas fa-ellipsis-v"></i>
//                         </Dropdown.Toggle>
//                         <Dropdown.Menu align="end">
//                             <Dropdown.Item onClick={() => handleEditUserClick(u)}><i className="fas fa-edit me-2 text-primary"></i>Edit User</Dropdown.Item>
//                             <Dropdown.Item onClick={() => handleResetPasswordClick(u)}><i className="fas fa-key me-2 text-warning"></i>Reset Password</Dropdown.Item>
//                             <Dropdown.Item onClick={() => handleToggleUserStatus(u)}>
//                                 <i className={`fas ${u.isActive ? 'fa-user-slash' : 'fa-user-check'} me-2 ${u.isActive ? 'text-secondary' : 'text-success'}`}></i>
//                                 {u.isActive ? 'Deactivate' : 'Activate'}
//                             </Dropdown.Item>
//                             <Dropdown.Divider />
//                             <Dropdown.Item onClick={() => handleDeleteUserClick(u)} className="text-danger"><i className="fas fa-trash-alt me-2"></i>Delete User</Dropdown.Item>
//                         </Dropdown.Menu>
//                       </Dropdown>
//                     </td>
//                   </tr>
...
//       {/* Common Modal Structure for Add/Edit */}
...
//           <Modal.Title>
//             <i className={`fas ${showAddUserModal ? 'fa-user-plus' : 'fa-user-edit'} me-2`}></i>
//             {showAddUserModal ? 'Add New User' : 'Edit User Details'}
//           </Modal.Title>
//         </Modal.Header>
...
//               <Form.Control type="text" name="username" value={showAddUserModal ? newUser.username : selectedUser?.username || ''} onChange={showAddUserModal ? handleNewUserChange : handleEditUserChange} required />
//             </Form.Group>
//             <Form.Group className="mb-3">
//               <Form.Label>Email <span className="text-danger">*</span></Form.Label>
//               <Form.Control type="email" name="email" value={showAddUserModal ? newUser.email : selectedUser?.email || ''} onChange={showAddUserModal ? handleNewUserChange : handleEditUserChange} required />
//             </Form.Group>
//             {showAddUserModal && (
//               <Form.Group className="mb-3">
...
//               <Form.Select name="role" value={showAddUserModal ? newUser.role : selectedUser?.role || 'crm'} onChange={showAddUserModal ? handleNewUserChange : handleEditUserChange} required>
//                 <option value="crm">CRM</option><option value="content">Content Team</option><option value="instructor">Instructor</option><option value="manager">Manager</option><option value="admin">Administrator</option>
//               </Form.Select>
//             </Form.Group>
//             {( (showAddUserModal && newUser.role === 'instructor') || (showEditUserModal && selectedUser?.role === 'instructor') ) && (
//               <Form.Group className="mb-3">
//                 <Form.Label>Assigned Tech Stacks</Form.Label>
//                 <Form.Select multiple name="assignedTechStacks" value={showAddUserModal ? newUser.assignedTechStacks : selectedUser?.assignedTechStacks || []} onChange={showAddUserModal ? handleNewUserChange : handleEditUserChange} style={{ height: '120px' }}>
//                   {allTechStacksForDropdown.map(stack => (<option key={stack._id} value={stack._id}>{stack.name}</option>))}
//                 </Form.Select>
//                 <Form.Text className="text-muted small">Hold Ctrl/Cmd to select multiple.</Form.Text>
//               </Form.Group>
//             )}
//             {showEditUserModal && selectedUser && (
//               <Form.Group><Form.Label>Account Status</Form.Label><Form.Check type="switch" name="isActive" id="user-active-switch" label={selectedUser.isActive ? "Active" : "Inactive"} checked={selectedUser.isActive} onChange={handleEditUserChange} /></Form.Group>
//             )}
//           </Modal.Body>
//           <Modal.Footer>
//             <Button variant="outline-secondary" onClick={() => { setShowAddUserModal(false); setShowEditUserModal(false); setError(null); }}>Cancel</Button>
//             <Button variant="primary" type="submit" disabled={actionLoading}>
//               {actionLoading ? <Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true" className="me-1" /> : null}
//               {showAddUserModal ? (actionLoading ? 'Creating...' : 'Create User') : (actionLoading ? 'Saving...' : 'Save Changes')}
//             </Button>
//           </Modal.Footer>
//         </Form>
//       </Modal>
      
//       <Modal show={showResetPasswordModal} onHide={() => {setShowResetPasswordModal(false); setError(null);}} centered>
//         <Modal.Header closeButton>
//           <Modal.Title><i className="fas fa-key me-2 text-warning"></i>Reset Password</Modal.Title>
//         </Modal.Header>
//         <Form onSubmit={handleResetPassword}>
//           <Modal.Body>
//             {error && <Alert variant="danger" className="py-2 small">{error}</Alert>}
//             {selectedUser && (<p>You are resetting the password for <strong>{selectedUser.username}</strong>.</p>)}
//             <Form.Group className="mb-3"><Form.Label>New Password <span className="text-danger">*</span></Form.Label><Form.Control type="password" name="newPassword" value={resetPassword.newPassword} onChange={handleResetPasswordChange} required /></Form.Group>
//             <Form.Group className="mb-3"><Form.Label>Confirm Password <span className="text-danger">*</span></Form.Label><Form.Control type="password" name="confirmPassword" value={resetPassword.confirmPassword} onChange={handleResetPasswordChange} required /></Form.Group>
//           </Modal.Body>
//           <Modal.Footer>
//             <Button variant="outline-secondary" onClick={() => {setShowResetPasswordModal(false); setError(null);}}>Cancel</Button>
...
//       <Modal show={showDeleteUserModal} onHide={() => {setShowDeleteUserModal(false); setError(null);}} centered>
//         <Modal.Header closeButton className="bg-danger-soft text-danger">
//           <Modal.Title><i className="fas fa-trash-alt me-2"></i>Delete User Confirmation</Modal.Title>
//         </Modal.Header>
...
//               <p>This will permanently delete the user <strong>{selectedUser.username}</strong>.</p>
//               <p className="text-danger fw-bold">This action cannot be undone.</p>
//             </>
//           )}
//         </Modal.Body>
//         <Modal.Footer className="justify-content-center">
//           <Button variant="outline-secondary" onClick={() => {setShowDeleteUserModal(false); setError(null);}}>Cancel</Button>
...
//         }
//         .user-table .no-caret::after { display: none; }
//         .user-role-badge { font-size: 0.7rem !important; font-weight: 500 !important; }
//         .user-status-badge { font-size: 0.7rem !important; font-weight: 500 !important; padding: 0.3em 0.6em !important;}
...
const UserManagement = () => {
  ...
  const [newUser, setNewUser] = useState({
    username: '', email: '', password: '', firstName: '', lastName: '', role: 'crm', assignedTechStacks: [], canManageRoadmaps: false, techStackPermission: 'none', canAccessCriticalPoints: false
  });
  ...
  const handleAddUserClick = () => {
    setNewUser({ username: '', email: '', password: '', firstName: '', lastName: '', role: 'crm', assignedTechStacks: [], canManageRoadmaps: false, techStackPermission: 'none', canAccessCriticalPoints: false });
    setError(null); setSuccess(null);
  ...
  const handleUpdateUser = async (e) => {
    ...
    setActionLoading(true);
    try {
      // --- FIX: Ensure the new permission is sent in the payload ---
      const { _id, username, email, firstName, lastName, role, isActive, assignedTechStacks, canManageRoadmaps, techStackPermission, canAccessCriticalPoints } = selectedUser;
      await userService.updateUser(_id, {
        username, email, firstName, lastName, role, isActive,
      ...
      // --- FIX: Refresh the user list to show the updated data in the table ---
      await fetchUsers();
      // --- END FIX ---
