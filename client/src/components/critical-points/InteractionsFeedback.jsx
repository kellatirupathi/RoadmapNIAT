    ...
    return (
        <Modal show={show} onHide={handleClose} centered size="lg">
             ...
             <Form onSubmit={handleSubmit}>
                <Modal.Body>
                    <Row>
                        <Col md={6}><Form.Group className="mb-3"><Form.Label>Interaction Dropdown</Form.Label><Form.Select name="interactionType" value={subData.interactionType} onChange={handleChange}><option>Fortnightly Review</option><option>Mid-point Check-in</option><option>Client Call</option><option>Internal Review</option></Form.Select></Form.Group><Form.Group className="mb-3"><Form.Label>Interaction Summary</Form.Label><Form.Select name="interactionSummary" value={subData.interactionSummary} onChange={handleChange}><option>Neutral</option><option>Positive feedback</option><option>Negative feedback</option></Form.Select></Form.Group></Col>
