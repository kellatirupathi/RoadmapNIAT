...
const InteractionsFeedback = ({ data, canEdit, onUpdate }) => {
    ...
    return (
        <>
            <style>{`
                .interactions-table { table-layout: fixed; border-collapse: collapse; font-size: 0.875rem; }
                .interactions-table th, .interactions-table td { padding: 0.85rem 0.6rem; border: 1px solid #dee2e6; vertical-align: top; }
                .interactions-table th { background-color: #f8f9fa; font-weight: 600; font-size: 0.8rem; }
